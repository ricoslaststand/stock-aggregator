...
export async function up(knex: Knex): Promise<void> {
    ...
    await knex.schema
        .createTableIfNotExists('stocks', function (table) {
    ...
    await knex.schema.createTableIfNotExists('daily_stock_prices', function (table) {
...
export async function down(knex: Knex): Promise<void> {
    ...
    await knex.schema
        .dropTableIfExists('daily_stock_prices');
}
